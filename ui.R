...
ui <- fluidPage(theme = shinytheme("united"),
  ...
  tags$head(tags$link(rel = "shortcut icon", type = "image/png", href = "covid.png")),
  ...
  navbarPage(title = div("COVID-19 Dashboard", style = "padding-left: 10px"),
    ...
    tabPanel("Table", icon = icon("list-alt"), page_fullTable, value = "page-fullTable"),
    ...
    navbarMenu("More", icon = icon("question-circle"),
               tabPanel(tags$a("", href = "https://github.com/elvrianae/Covid-19-Dashboard", target = "_blank",list(icon("github"), "Resources"))),
               tabPanel(tags$a("", href = "https://www.linkedin.com/in/elvriana-elvani-0481511a3/", target = "_blank",list(icon("linkedin"), "My Profile"))),
    ...
    header.append('<div style=\"float:right\"><a target=\"_blank\" href=\"https://www.youtube.com/watch?v=cNcLxXbFEEA\"><img src=\"mypict.png\" alt=\"alt\" style=\"float:right;width:33px;padding-top:10px;margin-top:-50px;margin-right:10px\"> </a></div>');
    console.log(header)")
    )
  )
)
